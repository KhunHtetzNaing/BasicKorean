...
public class thaya extends Activity implements B4AActivity{
	public static thaya mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.basickoreannew", "com.htetznaing.basickoreannew.thaya");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (thaya).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.basickoreannew", "com.htetznaing.basickoreannew.thaya");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.basickoreannew.thaya", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (thaya) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (thaya) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (thaya) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public com.htetznaing.basickoreannew.main _main = null;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 23;BA.debugLine="Activity.Title = \"သရ\"";
mostCurrent._activity.setTitle((Object)("သရ"));
 //BA.debugLineNum = 24;BA.debugLine="bg.Initialize(Colors.RGB(250,250,250),1)";
mostCurrent._bg.Initialize(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (250),(int) (250),(int) (250)),(int) (1));
 //BA.debugLineNum = 25;BA.debugLine="Activity.Background = bg";
mostCurrent._activity.setBackground((android.graphics.drawable.Drawable)(mostCurrent._bg.getObject()));
 //BA.debugLineNum = 27;BA.debugLine="tx.Initialize(\"\")";
mostCurrent._tx.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 28;BA.debugLine="tx.Text = File.ReadString(File.DirAssets,\"thaya.t";
mostCurrent._tx.setText((Object)(anywheresoftware.b4a.keywords.Common.File.ReadString(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"thaya.txt")));
 //BA.debugLineNum = 29;BA.debugLine="tx.TextColor = Colors.Black";
mostCurrent._tx.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 30;BA.debugLine="sc.Initialize(10000dip)";
mostCurrent._sc.Initialize(mostCurrent.activityBA,anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10000)));
 //BA.debugLineNum = 31;BA.debugLine="Activity.AddView(sc,0%x,0%y,100%x,100%y)";
...
mostCurrent._activity.AddView((android.view.View)(mostCurrent._banner.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0),mostCurrent.activityBA),(int) (anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50))),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)));
 //BA.debugLineNum = 38;BA.debugLine="Log(Banner)";
...
mostCurrent._interstitial.LoadAd();
 //BA.debugLineNum = 43;BA.debugLine="t.Initialize(\"t\",30000)";
...
mostCurrent._banner = new anywheresoftware.b4a.admobwrapper.AdViewWrapper();
 //BA.debugLineNum = 18;BA.debugLine="Dim Interstitial As InterstitialAd";
...
public static String  _t_tick() throws Exception{
 ...
 //BA.debugLineNum = 49;BA.debugLine="If Interstitial.Ready Then Interstitial.Show Else";
