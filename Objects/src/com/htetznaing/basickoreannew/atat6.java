...
public class atat6 extends Activity implements B4AActivity{
	public static atat6 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.basickoreannew", "com.htetznaing.basickoreannew.atat6");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (atat6).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.basickoreannew", "com.htetznaing.basickoreannew.atat6");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.basickoreannew.atat6", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (atat6) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (atat6) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (atat6) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 22;BA.debugLine="Activity.Title = \"ㅂ အသတ္\"";
mostCurrent._activity.setTitle((Object)("ㅂ အသတ္"));
...
mostCurrent._tx.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 27;BA.debugLine="tx.Text = File.ReadString(File.DirAssets,\"atat6.t";
mostCurrent._tx.setText((Object)(anywheresoftware.b4a.keywords.Common.File.ReadString(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"atat6.txt")));
