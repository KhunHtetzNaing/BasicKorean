...
public class atat5 extends Activity implements B4AActivity{
	public static atat5 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.basickoreannew", "com.htetznaing.basickoreannew.atat5");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (atat5).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.basickoreannew", "com.htetznaing.basickoreannew.atat5");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.basickoreannew.atat5", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (atat5) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (atat5) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (atat5) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 22;BA.debugLine="Activity.Title = \"ㅁ အသတ္\"";
mostCurrent._activity.setTitle((Object)("ㅁ အသတ္"));
...
mostCurrent._tx.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 27;BA.debugLine="tx.Text = File.ReadString(File.DirAssets,\"atat5.t";
mostCurrent._tx.setText((Object)(anywheresoftware.b4a.keywords.Common.File.ReadString(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"atat5.txt")));
