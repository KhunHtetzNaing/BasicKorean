...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.basickorean", "com.htetznaing.basickorean.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.basickorean", "com.htetznaing.basickorean.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.basickorean.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public com.htetznaing.basickorean.slidemenu _sm = null;
...
public com.htetznaing.basickorean.ams _ams = null;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 32;BA.debugLine="bg.Initialize(Colors.RGB(250,250,250),1)";
mostCurrent._bg.Initialize(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (250),(int) (250),(int) (250)),(int) (1));
 //BA.debugLineNum = 33;BA.debugLine="Activity.Background = bg";
...
mostCurrent._lb.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 36;BA.debugLine="lb.TextColor = Colors.Black";
mostCurrent._lb.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 37;BA.debugLine="lb.Text = File.ReadString(File.DirAssets,\"amarsar.";
mostCurrent._lb.setText((Object)(anywheresoftware.b4a.keywords.Common.File.ReadString(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"amarsar.txt")));
 //BA.debugLineNum = 38;BA.debugLine="sc.Initialize(1000dip)";
mostCurrent._sc.Initialize(mostCurrent.activityBA,anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (1000)));
 //BA.debugLineNum = 39;BA.debugLine="Activity.AddView(sc,0%x,0%y,100%x,100%y)";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._sc.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (0),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA));
 //BA.debugLineNum = 40;BA.debugLine="sc.Panel.AddView(lb,1%x,1%y,98%x,100%y)";
mostCurrent._sc.getPanel().AddView((android.view.View)(mostCurrent._lb.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (1),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (1),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (98),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA));
 //BA.debugLineNum = 41;BA.debugLine="sc.Height = 900dip";
mostCurrent._sc.setHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (900)));
 //BA.debugLineNum = 43;BA.debugLine="Activity.AddMenuItem3(\"Menu List\",\"menu\",LoadBitm";
mostCurrent._activity.AddMenuItem3("Menu List","menu",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"menu.png").getObject()),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 44;BA.debugLine="Activity.Title = \"Basic 한국어\"";
mostCurrent._activity.setTitle((Object)("Basic 한국어"));
 //BA.debugLineNum = 45;BA.debugLine="sm.Initialize(Activity, Me, \"SlideMenu\",0,70%x)";
mostCurrent._sm._initialize(mostCurrent.activityBA,mostCurrent._activity,main.getObject(),"SlideMenu",(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (70),mostCurrent.activityBA));
 //BA.debugLineNum = 46;BA.debugLine="sm.AddItem(\"အမွာစာ\",LoadBitmap(File.DirAssets,\"2.p";
mostCurrent._sm._additem("အမွာစာ",anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"2.png"),(Object)(1));
 //BA.debugLineNum = 47;BA.debugLine="sm.AddItem(\"ဗ်ည္း\",LoadBitmap(File.DirAssets,\"2.pn";
mostCurrent._sm._additem("ဗ်ည္း",anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"2.png"),(Object)(2));
 //BA.debugLineNum = 48;BA.debugLine="sm.AddItem(\"သရ\",LoadBitmap(File.DirAssets,\"2.png\")";
mostCurrent._sm._additem("သရ",anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"2.png"),(Object)(3));
 //BA.debugLineNum = 49;BA.debugLine="sm.AddItem(\"အသတ္မ်ား\",LoadBitmap(File.DirAssets,\"2";
mostCurrent._sm._additem("အသတ္မ်ား",anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"2.png"),(Object)(4));
 //BA.debugLineNum = 50;BA.debugLine="sm.AddItem(\"ㄱ အသတ္\",LoadBitmap(File.DirAssets,\"2.p";
mostCurrent._sm._additem("ㄱ အသတ္",anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"2.png"),(Object)(5));
 //BA.debugLineNum = 51;BA.debugLine="sm.AddItem(\"ㄴအသတ္\",LoadBitmap(File.DirAssets,\"2.pn";
mostCurrent._sm._additem("ㄴအသတ္",anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"2.png"),(Object)(6));
 //BA.debugLineNum = 52;BA.debugLine="sm.AddItem(\"ㄷ အသတ္\",LoadBitmap(File.DirAssets,\"2.p";
mostCurrent._sm._additem("ㄷ အသတ္",anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"2.png"),(Object)(7));
 //BA.debugLineNum = 53;BA.debugLine="sm.AddItem(\"ㄹအသတ္\",LoadBitmap(File.DirAssets,\"2.pn";
mostCurrent._sm._additem("ㄹအသတ္",anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"2.png"),(Object)(8));
 //BA.debugLineNum = 54;BA.debugLine="sm.AddItem(\"ㅁ အသတ္\",LoadBitmap(File.DirAssets,\"2.p";
mostCurrent._sm._additem("ㅁ အသတ္",anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"2.png"),(Object)(9));
 //BA.debugLineNum = 55;BA.debugLine="sm.AddItem(\"ㅂ အသတ္\",LoadBitmap(File.DirAssets,\"2.p";
mostCurrent._sm._additem("ㅂ အသတ္",anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"2.png"),(Object)(10));
 //BA.debugLineNum = 56;BA.debugLine="sm.AddItem(\"ㅇ အသတ္\",LoadBitmap(File.DirAssets,\"2.p";
mostCurrent._sm._additem("ㅇ အသတ္",anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"2.png"),(Object)(11));
 //BA.debugLineNum = 58;BA.debugLine="p.SetScreenOrientation(1)";
mostCurrent._p.SetScreenOrientation(processBA,(int) (1));
 //BA.debugLineNum = 59;BA.debugLine="If p.SdkVersion > 19 Then";
if (mostCurrent._p.getSdkVersion()>19) { 
 //BA.debugLineNum = 60;BA.debugLine="Banner.Initialize(\"Banner\",\"ca-app-pub-417334857";
mostCurrent._banner.Initialize(mostCurrent.activityBA,"Banner","ca-app-pub-4173348573252986/9432437755");
 //BA.debugLineNum = 61;BA.debugLine="Banner.LoadAd";
mostCurrent._banner.LoadAd();
 //BA.debugLineNum = 62;BA.debugLine="Activity.AddView(Banner,0%x,90%y,100%x,50dip)";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._banner.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (90),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)));
 //BA.debugLineNum = 64;BA.debugLine="Interstitial.Initialize(\"Interstitial\",\"ca-app-";
mostCurrent._interstitial.Initialize(mostCurrent.activityBA,"Interstitial","ca-app-pub-4173348573252986/9153236156");
 //BA.debugLineNum = 65;BA.debugLine="Interstitial.LoadAd";
mostCurrent._interstitial.LoadAd(mostCurrent.activityBA);
 //BA.debugLineNum = 67;BA.debugLine="t.Initialize(\"t\",120000)";
_t.Initialize(processBA,"t",(long) (120000));
 //BA.debugLineNum = 68;BA.debugLine="t.Enabled = True";
...
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 89;BA.debugLine="If  sm.isVisible Then";
if (mostCurrent._sm._isvisible()) { 
 //BA.debugLineNum = 90;BA.debugLine="sm.Hide";
mostCurrent._sm._hide();
 //BA.debugLineNum = 91;BA.debugLine="Return True";
if (true) return anywheresoftware.b4a.keywords.Common.True;
 }else {
 //BA.debugLineNum = 93;BA.debugLine="Dim mess As String = \"Do you want to Exit ?\"";
_mess = "Do you want to Exit ?";
 //BA.debugLineNum = 94;BA.debugLine="Dim abc As Int =  Msgbox2(mess,\"Attention!\",\"Yes";
_abc = anywheresoftware.b4a.keywords.Common.Msgbox2(_mess,"Attention!","Yes","","No",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null),mostCurrent.activityBA);
 //BA.debugLineNum = 95;BA.debugLine="If abc = DialogResponse.POSITIVE Then";
if (_abc==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 83;BA.debugLine="If sm.isVisible = True Then sm.Hide";
...
mostCurrent._sm = new com.htetznaing.basickorean.slidemenu();
 //BA.debugLineNum = 23;BA.debugLine="Dim bg As ColorDrawable";
mostCurrent._bg = new anywheresoftware.b4a.objects.drawable.ColorDrawable();
 //BA.debugLineNum = 24;BA.debugLine="Dim sc As ScrollView";
...
public static String  _menu_click() throws Exception{
 //BA.debugLineNum = 132;BA.debugLine="Sub menu_Click";
 //BA.debugLineNum = 133;BA.debugLine="If sm.isVisible Then sm.Hide Else sm.Show";
if (mostCurrent._sm._isvisible()) { 
mostCurrent._sm._hide();}
else {
...
public static String  _slidemenu_click(Object _item) throws Exception{
 //BA.debugLineNum = 104;BA.debugLine="Sub SlideMenu_Click(Item As Object)";
 //BA.debugLineNum = 105;BA.debugLine="sm.Hide";
mostCurrent._sm._hide();
 //BA.debugLineNum = 106;BA.debugLine="Select Item";
...
public static String  _t_tick() throws Exception{
 ...
 //BA.debugLineNum = 74;BA.debugLine="If Interstitial.Status = Interstitial.Status_AdRe";
if (mostCurrent._interstitial.Status==mostCurrent._interstitial.Status_AdReadyToShow) { 
 //BA.debugLineNum = 75;BA.debugLine="Interstitial.Show";
mostCurrent._interstitial.Show(mostCurrent.activityBA);
 };
 //BA.debugLineNum = 77;BA.debugLine="If Interstitial.Status = Interstitial.Status_Dism";
